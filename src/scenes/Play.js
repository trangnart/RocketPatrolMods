...
class Play extends Phaser.Scene {
    ...
    preload() {
        ...
        // load spritesheet
        this.load.spritesheet('explosion', './assets/explosion.png', {frameWidth: 60, frameHeight: 50, startFrame: 0, endFrame: 0});
    }
    ...
    create() {
        ...
        this.ship04 = new Spaceship(this, game.config.width + borderUISize*5, borderUISize*3, 'mice', 0, 50).setOrigin(0, 0); // mice implement
        // define keys
